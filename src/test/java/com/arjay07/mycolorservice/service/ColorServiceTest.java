...
class ColorServiceTest {
    ...
    void setUp() {
        ...
        when(colorRepository.findColorByHexIgnoreCase("ff0000")).thenReturn(Optional.of(red));
        ...
        when(colorRepository.findColorByHexIgnoreCase("00ff00")).thenThrow(ColorNotFoundException.class);
